                            ...
                            <div class="flex-fill col-md-6">
                                ...
                                <select id="gender" name="gender" class="form-control">
                                    ...
                                    <option value="masculino"
                                        {{ old('gender', $usuario->gender) == 'masculino' ? 'selected' : '' }}>Masculino
                                    </option>
                                    <option value="femenino"
                                        {{ old('gender', $usuario->gender) == 'femenino' ? 'selected' : '' }}>Femenino
                                    </option>
                                    <option value="otro"
                                        {{ old('gender', $usuario->gender) == 'otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                                @error('gender')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
