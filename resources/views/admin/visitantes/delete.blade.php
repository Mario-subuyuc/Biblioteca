...
<div class="row mb-3">
    <div class="col">
        ...
        <p class="text-danger">¡Atención! Esta acción es irreversible. Se eliminarán todos los registros relacionados con este visitante.</p>
    </div>
</div>
<hr>
<div class="row">
    <div class="col-md-8">
        <div class="card card-danger card-outline">
            ...
            <div class="card-body">
                <form action="{{ url('/admin/visitantes/'.$visitante->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="form-group d-flex justify-content-between">
                        <a href="{{ url('admin/visitantes') }}" class="btn btn-secondary">Cancelar</a>
                        <button type="submit" class="btn btn-danger">
                            <i class="bi bi-trash3"></i> Eliminar Visitante
                        </button>
                    </div>
                </form>
            </div>
