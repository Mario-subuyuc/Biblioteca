                    ...
                    <form action="{{ route('admin.visitantes.update', $visitante->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" value="{{ old('name', $visitante->name) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="location" value="{{ old('location', $visitante->location) }}"
                                    class="form-control">
                                @error('location')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="gender" class="form-control">
                                    ...
                                    <option value="Masculino"
                                        {{ old('gender', $visitante->gender) == 'Masculino' ? 'selected' : '' }}>Masculino
                                    </option>
                                    <option value="Femenino"
                                        {{ old('gender', $visitante->gender) == 'Femenino' ? 'selected' : '' }}>Femenino
                                    </option>
                                    <option value="Otro"
                                        {{ old('gender', $visitante->gender) == 'Otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                                @error('gender')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="ethnicity" id="ethnicity" class="form-control">
                                    <option value="" disabled hidden>-- Selecciona una etnia --</option>
                                    <option value="maya"
                                        {{ old('ethnicity', $visitante->ethnicity) == 'maya' ? 'selected' : '' }}>Maya
                                    </option>
                                    <option value="ladina"
                                        {{ old('ethnicity', $visitante->ethnicity) == 'ladina' ? 'selected' : '' }}>Ladina
                                    </option>
                                    <option value="garifuna"
                                        {{ old('ethnicity', $visitante->ethnicity) == 'garifuna' ? 'selected' : '' }}>
                                        Garífuna</option>
                                    <option value="xinca"
                                        {{ old('ethnicity', $visitante->ethnicity) == 'xinca' ? 'selected' : '' }}>Xinca
                                    </option>
                                    <option value="mestizo"
                                        {{ old('ethnicity', $visitante->ethnicity) == 'mestizo' ? 'selected' : '' }}>
                                        Mestizo</option>
                                    <option value="otro"
                                        {{ old('ethnicity', $visitante->ethnicity) == 'otro' ? 'selected' : '' }}>Otro
                                    </option>
                                </select>
                                @error('ethnicity')
                                    <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="occupation"
                                    value="{{ old('occupation', $visitante->occupation) }}" class="form-control">
                                @error('occupation')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                                ...
                                <select name="user_id" class="form-control">
                                    ...
                                    @foreach ($usuarios as $usuario)
                                        <option value="{{ $usuario->id }}"
                                            {{ old('user_id', $visitante->user_id) == $usuario->id ? 'selected' : '' }}>
                                            {{ $usuario->name }}
                                        </option>
                                    @endforeach
                                </select>
